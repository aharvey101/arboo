...
/// Test all log levels to ensure custom hierarchical filtering works correctly
/// Custom hierarchy: info (most restrictive) -> warn -> debug -> error -> trace (least restrictive)
#[test]
...
/// Integration test that demonstrates the custom hierarchical nature
#[test]
...
/// Test logger reinitialization behavior
#[test]
