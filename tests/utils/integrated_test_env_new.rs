...
impl IntegratedTestEnvironment {
    ...
    pub async fn new(config: TestEnvironmentConfig) -> Result<Self> {
        ...
        let anvil = create_mainnet_fork(
            &config.mainnet_fork_url,
            18_500_000, // Recent block
            None
        ...
        let mock_websocket = MockWebSocketProvider::new(format!("127.0.0.1:{}", websocket_port))
